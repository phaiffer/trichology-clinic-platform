...
public final class ReportMapper {
    ...
    public static ReportResponse toResponse(Report report, List<PatientPhoto> selectedPhotos) {
        return new ReportResponse(
                ...
                report.getScoreResult() != null ? report.getScoreResult().getId() : null,
                report.getScoreResult() != null ? report.getScoreResult().getScoreType() : null,
                report.getScoreResult() != null ? report.getScoreResult().getScoreValue() : null,
                report.getScoreResult() != null ? report.getScoreResult().getClassification() : null,
                report.getScoreResult() != null ? report.getScoreResult().getInterpretation() : null,
                report.getTitle(),
                report.getSummary(),
                report.getGeneratedAt(),
                report.getFileName(),
